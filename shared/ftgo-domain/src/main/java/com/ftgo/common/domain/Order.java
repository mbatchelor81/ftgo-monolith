...
import static com.ftgo.common.domain.OrderState.*;
...
public class Order {
    ...
    public List<OrderLineItem> getLineItems() { return orderLineItems.getLineItems(); }
    ...
    public void schedule(Courier assignedCourier) { this.assignedCourier = assignedCourier; }
