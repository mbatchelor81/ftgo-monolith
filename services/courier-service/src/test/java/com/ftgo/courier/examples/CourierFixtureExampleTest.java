 ...
 *
 * <p>Courier fixtures carry availability state that gates the
 * scheduling logic in the legacy monolith's
 * {@code CourierRepository.findAllAvailable()} query. The builder
 * exposes {@link CourierBuilder#available()} /
 * {@link CourierBuilder#unavailable()} to make that flip explicit in
 * test narratives.
 */
