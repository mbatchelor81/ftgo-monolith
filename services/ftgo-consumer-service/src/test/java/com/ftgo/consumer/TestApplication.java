 ...
 * Required because the consumer service does not yet have a main application class.
 *
 ...
 * the full SecurityFilterChainConfig which requires beans (JwtAuthenticationFilter,
 * etc.) not available in the @WebMvcTest slice. The authorization tests import
 * RoleHierarchyConfig directly for method-level security.
 */
