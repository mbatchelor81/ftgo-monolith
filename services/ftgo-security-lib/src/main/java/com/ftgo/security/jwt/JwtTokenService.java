 ...
 *
 * <p>Tokens include standard claims ({@code sub}, {@code iss}, {@code iat}, {@code exp}) plus
 * FTGO-specific claims ({@code userId}, {@code roles}, {@code permissions}).
 */
public class JwtTokenService {
     ...
     *
     * <p>Refresh tokens carry minimal claims — only enough to identify the user and validate the
     * token type during the refresh flow.
     *
     * @param userId unique user identifier
     * @param username the subject claim
