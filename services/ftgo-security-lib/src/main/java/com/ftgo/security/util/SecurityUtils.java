 ...
 *
 * <p>Provides static helper methods to inspect the current security context, retrieve the
 * authenticated principal, and check authorities/roles.
 *
 * <p>When JWT authentication is active, additional methods provide access to {@link
 * FtgoUserDetails} extracted from the token.
 */
public final class SecurityUtils {
    ...
    /**
     * Checks whether the current user holds a specific role. Automatically prepends {@code ROLE_}
     ...
     *
     * <p>Only available when the request was authenticated via a JWT token. Returns empty for
     * HTTP-Basic or other authentication mechanisms.
     */
