 ...
 *
 * <ul>
 *   <li>Requires authentication on all endpoints by default
 *   <li>Disables CSRF for stateless REST APIs
 *   <li>Uses stateless session management
 *   <li>Configures OAuth2 Resource Server with JWT validation when a {@link
 *       JwtAuthenticationConverter} is available
 *   <li>Falls back to HTTP Basic when JWT is not configured
 * </ul>
 *
