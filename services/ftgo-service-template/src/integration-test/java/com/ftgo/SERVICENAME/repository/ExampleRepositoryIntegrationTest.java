 ...
 *
 * <ul>
 *   <li>Use the @Tag("integration") annotation so the Gradle integrationTest task picks them up
 *   <li>Use Testcontainers for a real PostgreSQL instance
 *   <li>Use @DynamicPropertySource to inject container connection info
 *   <li>Test repository queries, Flyway migrations, and JPA mappings
 * </ul>
 *
