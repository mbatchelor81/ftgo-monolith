 ...
 * the canonical "hello world" example for new Order Service controllers.
 */
@RestController
@RequestMapping("/api/v1/service-info")
@Tag(
    name = "Service Info",
    description = "Metadata about the running Order Service instance."
)
public class ServiceInfoController {
  ...
  public static class ServiceInfoResponse {
    ...
    @Schema(description = "Spring application name", example = "order-service")
