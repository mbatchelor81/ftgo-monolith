...
public class CourierServiceHealthIndicator implements HealthIndicator {
    ...
    public CourierServiceHealthIndicator(CircuitBreakerRegistry circuitBreakerRegistry) {
        this.circuitBreakerRegistry = circuitBreakerRegistry;
    }

    @Override
    public Health health() {
        CircuitBreaker cb = circuitBreakerRegistry.circuitBreaker("courierService");
        ...
        return builder
                .withDetail("service", "courier-service")
